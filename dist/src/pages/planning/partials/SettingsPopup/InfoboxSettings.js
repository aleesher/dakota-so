...
var InfoboxSettings = function (_a) {
    ...
    var _b = react_1.useState(__spreadArrays(uiPreferences.popupFields)), popupFields = _b[0], setPopupFields = _b[1];
    function handleChange(index, value) {
        popupFields[index] = value;
        setPopupFields(__spreadArrays(popupFields));
    }
    function handleSave() {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(styles_1.SettingsContentWrapper, null, popupFields.map(function (field, i) { return (react_1.default.createElement(styles_1.FormRow, { key: field + i },
...
exports.default = InfoboxSettings;
//# sourceMappingURL=InfoboxSettings.js.map